...
5.2 - A fase de grupos começará 07/12/2023 terá prazo de 9 dias duração até às 23h do dia 16/12/2023; 
...
6.1 - Será utilizado o CHALLONGE para chaveamento das partidas do campeonato link (link);
...
6.4.3 - Para a final, informar o carro que será utilizado na partida normal e o carro que será utilizado para um possivel desempate;
...
7.2 - A gravação da partida será obrigatória.
