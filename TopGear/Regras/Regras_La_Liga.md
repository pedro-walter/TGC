...
- *CLASSIFICAÇÃO e REBAIXAMENTO*
  ...
  - Os critérios de desempate serão na seguinte ordem:
    Confronto Direto.
    Jogos Vencidos.
    Pontos Conquistados.
  - Quantidade
...
- *DESEMPATE PARA A FASE MATA-MATA*
  ...
  Caso se jogue UK e ao final da pista de Stonehenge a partida ainda não teve um vencedor seguindo os critérios acima, a partida continua a partir de USA.
...
- *COMUNICAÇÃO*
  ...
  Os jogadores devem anunciar o resultado de suas partidas no grupo.
  Os participantes que não realizarem suas partidas ou agendamento delas nos prazos aqui estabelecidos, através do grupo oficial do campeonato, estarão receberá W.O. aleatóriamente(sorteio) a critério da administração, caso não apresente as devidas justificativas.
  ...
  - Mensagens sem Relevância.
    O jogador que enviar mensagens no grupo, sem relevância para o campeonato, serão advertidos pela administração. Em caso de reincidência, o jogador será REMOVIDO do grupo.
...
- *REGRAS DE CONDUTA*
  ...
  - OBSERVAÇÕES:
    Mensagens trocadas em redes sociais particulares não serão consideradas.
    Denúncias e reclamações por ofensas somente serão consideradas e julgadas pela administração, se ocorrerem nos CANAIS OFICIAS DA TGC (Facebook, Whatsapp, Discord, Youtube, Twitch, Instagram e outros) ou chat da transmissão oficial de uma partida válida do campeonato. Chats privados (PV) e quaisquer outros meios não serão considerados.
...
- *REGRAS ESPECÍFICAS*
  ...
  A escolha de câmbio (automático ou manual) é livre durante todo o torneio.
