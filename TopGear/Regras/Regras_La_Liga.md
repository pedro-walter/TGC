...
# **1. Incrições:** #
  ...
  1.7 - Todos os participantes ao se inscreverem no campeonato, declaram estar cientes de todas as regras aqui estabelecidas e poderão sofrer as punições previstas, desde um w.o, uma possível eliminação do campeonato ou até exlusão da Comunidade.
  ...
  3 - *ORGANIZAÇÃO E CHAVEAMENTO*
      ...
      3.8 - Para a Série Bronze poderá ser aplicados modos diferentes de rodadas e fases finais conforme a quantidade de participantes.
  ...
  5 - *CLASSIFICAÇÃO e REBAIXAMENTO*
      ...
      5.3 - Os critérios de desempate serão na seguinte ordem:
          5.3.1 - Confronto Direto.
          5.3.2 - Jogos Vencidos.
          5.3.3 - Pontos Conquistados.
      5.4 - Quantidade
          5.4.1 - Série Ouro: = Permanecem na Série Ouro os 7 primeiros colocados da fase de grupos. Caem para a Série Prata, os 3 últimos colocados da fase de grupos.
          5.4.2 - Série Prata: = Os 3 primeiros colocados serão promovidos para a Série Ouro. Permanecem na Série Prata do 4° ao 7° colocados. Cairão para a Série Bronze, os 3 últimos colocados.
          5.4.3 - Série Bronze: Sobem os 3 primeiros colocados da Série Bronze para a Série Prata.
  ...
  6 - *DESEMPATE PARA A FASE MATA-MATA*
      ...
      6.6 - Usando a Rom TGC, deverão ser selecionadas no mínimo as 4 pistas do país subsequente ao último país sorteado. 
      6.7 - A administração sugere que sejam selecionadas as 8 primeiras da sequência, até que um jogador abra mais de 5 pontos primeiro.
      6.8 - Em permanecendo o empate, repete-se o processo até que haja um vencedor.
  ...
  7 - *COMUNICAÇÃO*
      ...
      7.8 - Mensagens sem Relevância:
          ...
          7.8.3 - Após 12h, o jogador removido poderá solicitar aos admins entrar novamente ao grupo.
 ...
 8 - *REGRAS DE CONDUTA*
    8.1 - Sobre o teor das mensagens trocadas entre os participantes:
        8.1.2 - Mensagens de zoeira e gozação são permitidas, desde que não sejam ofensivas segundo as regras a seguir, sendo passível de desclassificação do campeonato mensagens ofensivas que se enquadrem em pelo menos um dos tipos de discriminação abaixo, dirigidos ao jogador ou à sua família:
              - Racial ou étnica
              - Gênero
              - Religião
              - Status social
   ...
   8.2 - OBSERVAÇÕES:
       8.2.1 - Mensagens trocadas em redes sociais particulares não serão consideradas.
       8.2.2 - Denúncias e reclamações por ofensas somente serão consideradas e julgadas pela administração, se ocorrerem nos CANAIS OFICIAS DA TGC (Facebook, Whatsapp, Discord, Youtube, Twitch, Instagram e outros) ou chat da transmissão oficial de uma partida válida do campeonato. Chats privados (PV) e quaisquer outros meios não serão considerados.
       8.2.3 - Caracterizada a ofensa desrespeitosa com a dignidade da pessoa, a administração se reserva à punição única de exclusão do campeonato e proibição de inscrição no campeonato seguinte.
       8.2.4 - Outras medidas referentes a processos legais, deverão ser adotadas pelo próprio requerente.
       8.2.5 - Os print’s das mensagens ou áudios (enviados no período de realização do campeonato, nas redes oficiais da TGC), devem ser encaminhados através de protocolo conforme modelo no item a seguir, pelo facebook, no post de inscrição do campeonato e deverá ser respondido pela administração em um prazo máximo de 48h:
 ...
 9 - *REGRAS GERAIS*
   9.1 - https://www.facebook.com/columns/1290497698142905
   ...
   9.3 - Proibido o bug de bater no poste para ganhar duas posições;
   9.4 - Proibido o uso do freio em curvas para derrapagem (acelerador+freio), devido ao bug de não reduzir a velocidade ser exclusiva para o P1;
   9.5 - Proibido o uso do freio e ou parar na pista para prejudicar o adversário de maneira proposital e desleal;
 ...
 10 - *REGRAS ESPECÍFICAS*
    ...
    10.4 - A escolha de câmbio (automático ou manual) é livre durante todo o torneio.
 ...
 12 - *DISPOSIÇÕES FINAIS*
    12.1 - As regras podem ser modificadas durante o campeonato caso a administração julgue necessário para cobrir casos que não estejam cobertos por essas regras buscando não prejudicar os participantes.
    12.2 - A Administração da TGC deseja a todos os participantes um excelente campeonato!!!
